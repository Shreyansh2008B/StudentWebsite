...
function Project() {
    ...
    return (
        <section ref={ref} style={revealStyle(visible)} className={styles.Projectcontainer}>

            <div className={styles.cardWrapper}>
                <a href="https://github-explorer-one-dun.vercel.app" target="_blank" rel="noopener noreferrer" className={styles.cardLink}>
                    <Card
            ...
            <div className={styles.buttonContainer}>
                <a href="https://github.com/Shreyansh2008B" target="_blank" rel="noopener noreferrer" className={styles.viewAllBtn}>
                    View All Projects 🚀
                </a>
            </div>
